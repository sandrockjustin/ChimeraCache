...
class ChimeraCache {
  ...
  constructor(options = {}) {
    ...
    if (this.#overrides.ignore_defaults) {
      ...
      this.#invalidation = {
        protocol: options.invalidation.protocol ? options.invalidation.protocol.toLowerCase() : 'static',
        caching: {
          limit: {
      ...
      this.#fallback = {
        ...
        protocol: options.fallback.protocol ? options.fallback.protocol.toLowerCase() : 'flex', 
        threshold_min: options.fallback.threshold_min ? options.fallback.threshold_min : 0.7,
        threshold_max: options.fallback.threshold_max ? options.fallback.threshold_max : 0.85,
